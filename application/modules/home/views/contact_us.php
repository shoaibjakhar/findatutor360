            ...
            <div class="row ">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 no-padleft">
                    ...
                    <ul class="social-share">
                        <?php $fb_follow=$this->config->item('social_settings')->facebook;

                        if(!empty($fb_follow)) { ?>
                        <li class="fb-color"><a href="<?php echo $fb_follow;?>" target="_blank" title="Follow us on Facebook"><i class="fa fa-facebook"></i></a></li>
                        <?php } 
                        $tw_follow=$this->config->item('social_settings')->twitter;

                        if(!empty($tw_follow)) { ?>
                        <li ><a class="tw-color" href="<?php echo $tw_follow;?>" target="_blank" title="Follow us on Twitter"><i class="fa fa-twitter"></i></a></li>
                        <?php }
                        $ggl_follow = $this->config->item('social_settings')->google;

                        if(!empty($ggl_follow)) { ?>
                        <li><a class="gp-color" href="<?php echo $ggl_follow;?>" target="_blank" title="Follow us on Google"><i class="fa fa-google-plus"></i></a></li>
                        <?php }  
                        $yu_follow=$this->config->item('social_settings')->youtube;

                        if(!empty($yu_follow)) { ?>
                        <li class="yt-color"><a href="<?php echo $yu_follow;?>" target="_blank" title="Follow us on Youtube"><i class="fa fa-youtube-play"></i></a></li>
                        <?php } ?>
                    </ul>
