                ...
                <table width="100%" class="table table-striped">
                  ...
                  <tbody>
					...
					if(count($records) > 0) 
					{
						...
						{
							if($record == 'lang_id' || $record == 'lang_key' || $record == 'phrase_for') continue;
						?>
					<tr>                      
                      ...
                      <td>
						...
						<div class="digiCrud">
							<a title="<?php echo get_languageword('update_language_strings');?>" href="<?php echo URL_LANGUAGE_ADDLANGUEGEPHRASES?>/<?php echo $record;?>">
								<?php echo get_languageword('update_language_strings');?>
							</a>
						</div>
						<?php } ?>
                        </td>
