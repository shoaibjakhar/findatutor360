    ...
    <div class="col-lg-12">
      ...
      <?php 
         ...
         foreach( $languagewords as $row) { ?>
              <div class="form-group">
                <div class="group ap">
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <label class="digiEffectLabel" data-toggle="tooltip" title="English Text (Phrase) <?php echo $row->phrase_for;?>"><?php echo $row->english;?> (<?php echo $row->lang_key;?>) (Phrase For <?php echo $row->phrase_for;?>) </label>
                    </div>
        ...
        <div class="form-group text-right">
             <button type="submit" class="digi-defult-btn digi-premier-btn" name="submitbutt" value="update">
          <i class="fa fa-send"></i> <?php echo get_languageword('update');?> 
            </button>
