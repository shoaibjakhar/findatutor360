...
class Welcome extends MY_Controller {
	...
	function index()
	{
		...
		/**website v2 upgradation of db - for v1 users**/
		$this->load->database();

		$table1_query = "CREATE TABLE IF NOT EXISTS `pre_course_downloads` (
						  `cd_id` bigint(20) PRIMARY KEY AUTO_INCREMENT,
		...
		$table2_query = "CREATE TABLE IF NOT EXISTS `pre_course_purchases` (
						  `purchase_id` bigint(20) PRIMARY KEY AUTO_INCREMENT,
						  `sc_id` int(11) NOT NULL,
						  `tutor_id` int(11) NOT NULL,
						  `user_id` int(11) NOT NULL,
		...
		$table3_query = "CREATE TABLE IF NOT EXISTS `pre_payments_data` (
		...
		$table4_query = "CREATE TABLE IF NOT EXISTS `pre_sections` (
		...
		$table5_query = "CREATE TABLE IF NOT EXISTS `pre_seosettings` (
		...
		$table6_query = "CREATE TABLE IF NOT EXISTS `pre_tpay_data` (
						  `id` int(11) PRIMARY KEY AUTO_INCREMENT,
						  `data` text,
						  `created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
						) ENGINE=InnoDB DEFAULT CHARSET=utf8";				
		...
		$table7_query = "CREATE TABLE IF NOT EXISTS `pre_tutor_selling_courses` (
		...
		$table8_query = "CREATE TABLE IF NOT EXISTS `pre_tutor_selling_courses_curriculum` (
		...
		$table9_query = "CREATE TABLE IF NOT EXISTS `pre_webmoney_data` (
						  `id` int(11) PRIMARY KEY AUTO_INCREMENT,
						  `data` text,
						  `created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
						) ENGINE=InnoDB DEFAULT CHARSET=utf8";
		...
		//Insert Operations
		$table1_insert_query = "INSERT IGNORE INTO `pre_course_downloads` (`cd_id`, `purchase_id`, `sc_id`, `tutor_id`, `user_id`, `ip_address`, `browser`, `browser_version`, `platform`, `mobile_device`, `robot`, `is_download_success`, `downloaded_date`) VALUES
		...
		$table4_insert_query = "INSERT IGNORE INTO `pre_sections` (`section_id`, `name`, `description`) VALUES
		...
		$table5_insert_query = "INSERT IGNORE INTO `pre_seosettings` (`id`, `type`, `allowed_variables`, `seo_title`, `seo_description`, `seo_keywords`, `created`, `updated`) VALUES
		...
		$table8_insert_query = "INSERT IGNORE INTO `pre_tutor_selling_courses_curriculum` (`file_id`, `sc_id`, `title`, `source_type`, `file_name`, `file_ext`, `file_size`) VALUES
			...
			$settings_table_insert_query = "INSERT IGNORE INTO `pre_system_settings_fields` (`field_id`, `type_id`, `field_name`, `field_key`, `is_required`, `field_order`, `field_type`, `field_type_values`, `field_output_value`, `field_type_slug`, `created`, `updated`) VALUES
			...
			$query = "INSERT IGNORE INTO `pre_system_settings_types` (`type_id`,`type_title`,`parent_id`,`type_slug`,`created`,`updated`,`is_default`,`status`) VALUES
				(50,'Bigbluebutton',0,'bigbluebutton','2017-02-03 18:49:13',NULL,'No','Active')";
			$this->db->query($query);

			$query = "INSERT IGNORE INTO `pre_system_settings_fields` (`field_id`,`type_id`,`field_name`,`field_key`,`is_required`,`field_order`,`field_type`,`field_type_values`,`field_output_value`,`field_type_slug`,`created`,`updated`) VALUES
		...
		/**Mobile app v1 - without multi language**/
		//users table - device_id column
		$users=0;
		$query='ALTER TABLE pre_users ADD COLUMN IF NOT EXISTS device_id varchar(500) DEFAULT NULL';
		
		$users =  $this->db->query($query);
		
		
		
		//pre_system_settings_types - insert 1 record-push notification settings
		$system_settings_types=0;
		$query = "INSERT IGNORE INTO `pre_system_settings_types`(`type_id`, `type_title`, `parent_id`, `type_slug`, `created`, `updated`, `is_default`, `status`) VALUES (51,'Push Notification Settings',0,'PUSH_NOTIFICATION_SETTINGS',null,null,'No','Active')";
		
		$system_settings_types = $this->db->query($query);
		
		
	
		//pre_system_settings_fields - insert 4 records - 
		//1 is - push_notification_settings=yes/no
		//3 are - push notification settings - records
		$one_signal_push_notifications=0;
		$query = "INSERT IGNORE INTO `pre_system_settings_fields`(`field_id`, `type_id`, `field_name`, `field_key`, `is_required`, `field_order`, `field_type`, `field_type_values`, `field_output_value`, `field_type_slug`, `created`, `updated`) VALUES (204,1,'One Signal Push Notifications','One_Signal_Push_Notifications','Yes',0,'select','yes,no','yes',null,null,null)";
		$one_signal_push_notifications = $this->db->query($query);//1

		
		$one_signal_app_id=0;
		$query="INSERT IGNORE INTO `pre_system_settings_fields`(`field_id`, `type_id`, `field_name`, `field_key`, `is_required`, `field_order`, `field_type`, `field_type_values`, `field_output_value`, `field_type_slug`, `created`, `updated`) VALUES (202,51,'One Signal App ID','One_Signal_App_ID','Yes',0,'text',null,null,null,null,null)";
		$one_signal_app_id =  $this->db->query($query);

		
		$one_signal_server_API_key=0;
		$query="INSERT IGNORE INTO `pre_system_settings_fields`(`field_id`, `type_id`, `field_name`, `field_key`, `is_required`, `field_order`, `field_type`, `field_type_values`, `field_output_value`, `field_type_slug`, `created`, `updated`) VALUES (203,51,'One Signal Server API Key','One_Signal_Server_API_Key','Yes',0,'text',null,null,null,null,null)";
		$one_signal_server_API_key =  $this->db->query($query);
		
		
		$project_no=0;
		$query="INSERT IGNORE INTO `pre_system_settings_fields`(`field_id`, `type_id`, `field_name`, `field_key`, `is_required`, `field_order`, `field_type`, `field_type_values`, `field_output_value`, `field_type_slug`, `created`, `updated`) VALUES (205,51,'Project No','Project_No','Yes',0,'text',null,null,null,null,null);";
		$project_no =  $this->db->query($query);
		
		
		//create tables 
		//1.pre_booking_answers
		//2.pre_booking_questions
		//3.pre_chat
		//4.pre_student_fav_tutors
		//5.pre_tutor_blogs
		
		//1.pre_booking_answers
		$pre_booking_answers=0;
		$query="CREATE TABLE IF NOT EXISTS `pre_booking_answers` (
		  `answer_id` int(11) PRIMARY KEY AUTO_INCREMENT,
		  `question_id` int(11) DEFAULT NULL,
		  `from_id` int(11) DEFAULT NULL,
		  `to_id` int(11) DEFAULT NULL,
		  `message` text CHARACTER SET utf8,
		  `student_status` enum('0','1') NOT NULL DEFAULT '0',
		  `tutor_status` enum('0','1') NOT NULL DEFAULT '0',
		  `datetime` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP
		) ENGINE=MyISAM DEFAULT CHARSET=utf8";
		$pre_booking_answers =  $this->db->query($query);
		
		
		//2.pre_booking_questions
		$pre_booking_questions=0;
		$query="CREATE TABLE IF NOT EXISTS `pre_booking_questions` (
		  `question_id` int(11) PRIMARY KEY AUTO_INCREMENT,
		  `booking_id` int(11) DEFAULT NULL,
		  `question_text` text CHARACTER SET utf8,
		  `datetime` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP
		) ENGINE=MyISAM DEFAULT CHARSET=utf8";
		$pre_booking_questions =  $this->db->query($query);

		
		//3.pre_chat
		$pre_chat=0;
		$query="CREATE TABLE IF NOT EXISTS `pre_chat` (
		  `id` int(11) PRIMARY KEY AUTO_INCREMENT,
		  `from_id` int(11) DEFAULT NULL,
		  `to_id` int(11) DEFAULT NULL,
		  `message` text,
		  `student_status` int(1) NOT NULL DEFAULT '0',
		  `tutor_status` int(1) NOT NULL DEFAULT '0',
		  `status` int(1) NOT NULL DEFAULT '0',
		  `datetime` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP
		) ENGINE=MyISAM DEFAULT CHARSET=utf8";
		$pre_chat =  $this->db->query($query);

		
		
		//4.pre_student_fav_tutors
		$pre_student_fav_tutors=0;
		$query="CREATE TABLE IF NOT EXISTS `pre_student_fav_tutors` (
		  `fav_id` int(11) PRIMARY KEY AUTO_INCREMENT,
		  `student_id` int(11) DEFAULT NULL,
		  `tutor_id` int(11) DEFAULT NULL,
		  `datetime` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP
		) ENGINE=MyISAM DEFAULT CHARSET=utf8";
		$pre_student_fav_tutors =  $this->db->query($query);

		
		//5.pre_tutor_blogs
		$pre_tutor_blogs=0;
		$query="CREATE TABLE IF NOT EXISTS `pre_tutor_blogs` (
		  `blog_id` int(11) PRIMARY KEY AUTO_INCREMENT,
		  `tutor_id` int(11) DEFAULT NULL,
		  `title` varchar(1000) NOT NULL,
		  `related_to` varchar(1000) NOT NULL,
		  `description` text,
		  `image_url` varchar(200) DEFAULT NULL,
		  `created` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
		  `updated` datetime DEFAULT NULL,
		  `blog_status` enum('Active','Inactive') DEFAULT NULL,
		  `admin_approved` enum('Yes','No') DEFAULT NULL,
		  `approved_datetime` datetime DEFAULT NULL
		) ENGINE=MyISAM DEFAULT CHARSET=utf8";
		$pre_tutor_blogs =  $this->db->query($query);
		...
		/**Mobile app v1 - with multi language**/
		//changes multi language mobile app 05-04-2018
		$code=0;
		$query='ALTER TABLE pre_languages ADD COLUMN IF NOT EXISTS code varchar(10) DEFAULT NULL';
		$code =  $this->db->query($query);


		$phrasefor=0;
		$query="ALTER TABLE pre_languagewords ADD COLUMN IF NOT EXISTS phrase_for ENUM('Web','App') DEFAULT 'Web' ";
		$phrasefor =  $this->db->query($query);
	...
	****************************/
	function db_changes()
	{
		//google_api_key_for_language column in system_settings
		//enable_google_api_key column in system_settings
		
		//enable google api key
		$enable_google_api_key_for_language=0;
		$query = "INSERT IGNORE INTO `pre_system_settings_fields`(`field_id`, `type_id`, `field_name`, `field_key`, `is_required`, `field_order`, `field_type`, `field_type_values`, `field_output_value`, `field_type_slug`, `created`, `updated`) VALUES (300,1,'Enable Google API for Language','Enable_Google_API_Key','Yes',0,'select','yes,no','no',NULL,NULL,NULL)";
		$enable_google_api_key_for_language = $this->db->query($query);//1


		

		//google api key 
		$google_api_key_for_language=0;
		$query = "INSERT IGNORE INTO `pre_system_settings_fields`(`field_id`, `type_id`, `field_name`, `field_key`, `is_required`, `field_order`, `field_type`, `field_type_values`, `field_output_value`, `field_type_slug`, `created`, `updated`) VALUES (301,1,'Google API for Language','Google_API_Key','No',0,'text',null,null,null,null,null)";
		$google_api_key_for_language = $this->db->query($query);//1


		//pre_notifications table
		$pre_notifications=0;
		$query="CREATE TABLE IF NOT EXISTS `pre_notifications` (
		 `notification_id` int(10) PRIMARY KEY AUTO_INCREMENT NOT NULL,
		  `user_id` int(11) DEFAULT NULL,
		  `title` varchar(200) CHARACTER SET utf8 DEFAULT NULL,
		  `content` varchar(512) CHARACTER SET utf8 DEFAULT NULL,
		  `datetime` datetime DEFAULT NULL,
		  `admin_read` int(1) NOT NULL DEFAULT '0',
		  `admin_read_date` datetime DEFAULT NULL,
		  `page_link` varchar(512) CHARACTER SET utf8 DEFAULT NULL,
		  `table_name` varchar(50) CHARACTER SET utf8 DEFAULT NULL,
		  `primary_key_column` varchar(50) CHARACTER SET utf8 DEFAULT NULL,
		  `primary_key_value` int(11) DEFAULT NULL
		) ENGINE=MyISAM DEFAULT CHARSET=utf8";
		$pre_notifications =  $this->db->query($query);



		//is_certificate_issued in bookings table
		$is_certificate_issued=0;
		$query="ALTER TABLE pre_bookings ADD COLUMN IF NOT EXISTS is_certificate_issued enum('Yes','No') CHARACTER SET utf8 NOT NULL DEFAULT 'No'";
		$is_certificate_issued =  $this->db->query($query);



		//certificate_issue_date in bookings table
		$is_certificate_issued=0;
		$query="ALTER TABLE pre_bookings ADD COLUMN IF NOT EXISTS certificate_issue_date date CHARACTER SET utf8 DEFAULT NULL";
		$certificate_issue_date =  $this->db->query($query);



		//category_id in tutor_selling_coures table
		$category_id=0;
		$query="ALTER TABLE pre_tutor_selling_courses ADD COLUMN IF NOT EXISTS category_id int(11) DEFAULT NULL";
		$category_id =  $this->db->query($query);



		//created_by in pre_locations table
		$created_by=0;
		$query="ALTER TABLE pre_locations ADD COLUMN IF NOT EXISTS created_by int(11) DEFAULT NULL";
		$created_by =  $this->db->query($query);


		//updated_by in pre_locations table
		$updated_by=0;
		$query="ALTER TABLE pre_locations ADD COLUMN IF NOT EXISTS updated_by int(11) DEFAULT NULL";
		$updated_by =  $this->db->query($query);



		//created_by in pre_categories table
		$created_by=0;
		$query="ALTER TABLE pre_categories ADD COLUMN IF NOT EXISTS created_by int(11) DEFAULT NULL";
		$created_by =  $this->db->query($query);


		//updated_by in pre_categories table
		$updated_by=0;
		$query="ALTER TABLE pre_categories ADD COLUMN IF NOT EXISTS updated_by int(11) DEFAULT NULL";
		$updated_by =  $this->db->query($query);



		//Tutor_Locations_Enable in system_settings_fields table
		$tutor_locations_enable=0;
		$query = "INSERT IGNORE INTO `pre_system_settings_fields`(`field_id`, `type_id`, `field_name`, `field_key`, `is_required`, `field_order`, `field_type`, `field_type_values`, `field_output_value`, `field_type_slug`, `created`, `updated`) VALUES (302,1,'Tutor Locations Enable','Tutor_Locations_Enable','Yes',0,'select','yes,no','no','SYSTEM_SETTINGS',NULL,NULL)";
		$tutor_locations_enable = $this->db->query($query);//1



		//Tutor_Courses_Enable in system_settings_fields table
		$tutor_courses_enable=0;
		$query = "INSERT IGNORE INTO `pre_system_settings_fields`(`field_id`, `type_id`, `field_name`, `field_key`, `is_required`, `field_order`, `field_type`, `field_type_values`, `field_output_value`, `field_type_slug`, `created`, `updated`) VALUES (303,1,'Tutor Courses Enable','Tutor_Courses_Enable','Yes',0,'select','yes,no','no','SYSTEM_SETTINGS',NULL,NULL)";
		$tutor_courses_enable = $this->db->query($query);//1



		//Facebook_App_Id in system_settings_fields table
		$facebook_app_id=0;
		$query = "INSERT IGNORE INTO `pre_system_settings_fields`(`field_id`, `type_id`, `field_name`, `field_key`, `is_required`, `field_order`, `field_type`, `field_type_values`, `field_output_value`, `field_type_slug`, `created`, `updated`) VALUES (304,1,'Facebook App ID','Facebook_App_Id','No',0,'text',NULL,NULL,'SYSTEM_SETTINGS',NULL,NULL)";
		$facebook_app_id = $this->db->query($query);//1


		//Facebook_App_Secret in system_settings_fields table
		$facebook_app_secret=0;
		$query = "INSERT IGNORE INTO `pre_system_settings_fields`(`field_id`, `type_id`, `field_name`, `field_key`, `is_required`, `field_order`, `field_type`, `field_type_values`, `field_output_value`, `field_type_slug`, `created`, `updated`) VALUES (305,1,'Facebook App Secret','Facebook_App_Secret','No',0,'text',NULL,NULL,'SYSTEM_SETTINGS',NULL,NULL)";
		$facebook_app_secret = $this->db->query($query);//1


		//Google_Client_Id in system_settings_fields table
		$google_client_id=0;
		$query = "INSERT IGNORE INTO `pre_system_settings_fields`(`field_id`, `type_id`, `field_name`, `field_key`, `is_required`, `field_order`, `field_type`, `field_type_values`, `field_output_value`, `field_type_slug`, `created`, `updated`) VALUES (306,1,'Google Client ID','Google_Client_Id','No',0,'text',NULL,NULL,'SYSTEM_SETTINGS',NULL,NULL)";
		$google_client_id = $this->db->query($query);//1


		//Google_Client_Secret in system_settings_fields table
		$google_client_secret=0;
		$query = "INSERT IGNORE INTO `pre_system_settings_fields`(`field_id`, `type_id`, `field_name`, `field_key`, `is_required`, `field_order`, `field_type`, `field_type_values`, `field_output_value`, `field_type_slug`, `created`, `updated`) VALUES (307,1,'Google Client Secret','Google_Client_Secret','No',0,'text',NULL,NULL,'SYSTEM_SETTINGS',NULL,NULL)";
		$google_client_secret = $this->db->query($query);//1



		//Facebook_Login_Enable in system_settings_fields table
		$facebook_login_enable=0;
		$query = "INSERT IGNORE INTO `pre_system_settings_fields`(`field_id`, `type_id`, `field_name`, `field_key`, `is_required`, `field_order`, `field_type`, `field_type_values`, `field_output_value`, `field_type_slug`, `created`, `updated`) VALUES (308,1,'Facebook Login Enable','Facebook_Login_Enable','Yes',0,'select','yes,no','no','SYSTEM_SETTINGS',NULL,NULL)";
		$facebook_login_enable = $this->db->query($query);//1


		//Google_Login_Enable in system_settings_fields table
		$google_login_enable=0;
		$query = "INSERT IGNORE INTO `pre_system_settings_fields`(`field_id`, `type_id`, `field_name`, `field_key`, `is_required`, `field_order`, `field_type`, `field_type_values`, `field_output_value`, `field_type_slug`, `created`, `updated`) VALUES (309,1,'Google Login Enable','Google_Login_Enable','Yes',0,'select','yes,no','no','SYSTEM_SETTINGS',NULL,NULL)";
		$google_login_enable = $this->db->query($query);//1



		//oauth_provider in pre_users table
		$oauth_provider=0;
		$query="ALTER TABLE pre_users ADD COLUMN IF NOT EXISTS oauth_provider varchar(255) DEFAULT NULL";
		$oauth_provider =  $this->db->query($query);



		//oauth_uid in pre_users table
		$oauth_uid=0;
		$query="ALTER TABLE pre_users ADD COLUMN IF NOT EXISTS oauth_uid varchar(255) DEFAULT NULL";
		$oauth_uid =  $this->db->query($query);



		//Contact_Map_Script in system_settings_fields table
		$contact_map_script=0;
		$query = "INSERT IGNORE INTO `pre_system_settings_fields`(`field_id`, `type_id`, `field_name`, `field_key`, `is_required`, `field_order`, `field_type`, `field_type_values`, `field_output_value`, `field_type_slug`, `created`, `updated`) VALUES (310,1,'Contact Map Script','Contact_Map_Script','Yes',0,'text',NULL,NULL,'SYSTEM_SETTINGS',NULL,NULL)";
		$contact_map_script = $this->db->query($query);//1
	...
	/**front end language row in pre_system_settings_fields table**/
	public function update_home_lang_column()
	{

		//execute method run below query
		$Front_End_Languages=0;
		$query = "INSERT IGNORE INTO `pre_system_settings_fields`(`field_id`, `type_id`, `field_name`, `field_key`, `is_required`, `field_order`, `field_type`, `field_type_values`, `field_output_value`, `field_type_slug`, `created`, `updated`) VALUES (999,1,'Front End Languages','Front_End_Languages','Yes',0,'select','english,french,hindi,arabic,urdu,dutch,japanese,german,chinese,danish,czech,greek,hebrew,italian,latin,portuguese,nepali,spanish,indonesian,irish,bengali,russian','english','SYSTEM_SETTINGS',null,null)";
		$Front_End_Languages_query = $this->db->query($query);//1

		redirect(URL_AUTH_LOGIN); 

		/**
		Without execute query-- add row in pre_system_settings_fields table

		pre_system_settings_fields table
		...
		field_name: Front End Languages

		field_key:  Front_End_Languages
		...
		field_type_values: english,french,hindi,arabic,urdu,dutch,japanese,german,chinese,danish,czech,greek,hebrew,italian,latin,portuguese,nepali,spanish,indonesian,irish,bengali,russian
		
		field_output_value: english


		field_type_slug: SYSTEM_SETTINGS
